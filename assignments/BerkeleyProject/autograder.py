...
import assignments.BerkeleyProject.grading as grading
import importlib.util
import optparse
import os
import re
import sys
import assignments.BerkeleyProject.projectParams as projectParams
import random
random.seed(0)
try: 
    from assignments.BerkeleyProject.pacman import GameState
except:
    pass
...
def runTest(testName, moduleDict, printTestCase=False, display=None):
    import assignments.BerkeleyProject.testParser as testParser
    import assignments.BerkeleyProject.testClasses as testClasses
